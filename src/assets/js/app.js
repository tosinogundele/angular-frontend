!function(o) {
    "use strict";
    var e, t = localStorage.getItem("language"), a = "eng";
    function n(e) {
        "eng" == e ? document.getElementById("header-lang-img").src = "assets/images/flags/us.jpg" : "sp" == e ? document.getElementById("header-lang-img").src = "assets/images/flags/spain.jpg" : "gr" == e ? document.getElementById("header-lang-img").src = "assets/images/flags/germany.jpg" : "it" == e ? document.getElementById("header-lang-img").src = "assets/images/flags/italy.jpg" : "ru" == e && (document.getElementById("header-lang-img").src = "assets/images/flags/russia.jpg"),
        localStorage.setItem("language", e),
        null == (t = localStorage.getItem("language")) && n(a),
        o.getJSON("assets/lang/" + t + ".json", function(e) {
            o("html").attr("lang", t),
            o.each(e, function(e, t) {
                "head" === e && o(document).attr("title", t.title),
                o("[key='" + e + "']").text(t)
            })
        })
    }
    ...
    function c() {
        ...
        o(".edit-icon").click(function(e) {
            var t = o(this).parent();
            o(".dashboard_new_name").hide(),
            o(".dashboard_name").show();
            var a = t.find(".dashboard_name").text();
            t.find(".dashboard_new_name").val(a),
            t.find(".dashboard_name").hide(),
            t.find(".dashboard_new_name").show(),
            o(this).hide()
        }),
        o(".dashboard_new_name").keyup((a = function(e) {
            var t = o(this).parent()
              ...
              , n = o(this).val();
            a.html(n),
            t.find(".dashboard_name").show(),
            t.find(".dashboard_new_name").hide(),
            o(".edit-icon").show()
        }
        ,
        n = 500,
    ...
    o(document).ready(function() {
        var e;
        0 < o("#sidebar-menu").length && 0 < o("#sidebar-menu .mm-active .active").length && (300 < (e = o("#sidebar-menu .mm-active .active").offset().top) && (e -= 300,
        o(".simplebar-content-wrapper").animate({
            scrollTop: e
        }, "slow")))
    }),
